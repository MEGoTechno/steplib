...
export const sidebarLinks = [
    ...
    // }, 
    {
        ...
        name: "الاختبارات", icon: <MdQuestionAnswer size="22px" />, to: "/management/attempts", allowedTo: [user_roles.ADMIN, user_roles.SUBADMIN], isDisabled: true, info: { title: 'جديد', i: 1 },
...
const otherLinks = [
    {
        ...
        name: "الكورسات", icon: <LiaSchoolSolid size="22px" />,
        path: "/grades", allowedTo: [user_roles.STUDENT, user_roles.ONLINE], element: <GradesPage />
    },{
